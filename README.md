        ...
        providers: [
          {
            ...
            options: {
              ...
              returnUrl: "https://shop.example.com/checkout/niftipay-return?cart_id={cart_id}",
              failureUrl: "https://shop.example.com/checkout?step=payment&niftipay=failed",
...
optional `brand_slug` selects matching entries from `brandSettings`.
